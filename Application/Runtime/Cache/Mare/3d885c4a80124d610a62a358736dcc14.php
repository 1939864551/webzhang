								...
								<form class="form-inline" action="<?php echo U('Mare/Report/rep_down');?>" id="downloadreport" method="post">
									<div class="clearfix row-bottom">
										...
										<div class="col-md-9 form-group-input">								
											<div class="form-group">
												<div class="input-group select-inline">
													<span><?php echo explode('_',$taskinfo['task_name'])[0]; ?></span>
													<input type="hidden" name="appid" value="<?php echo ($_GET['appid']); ?>" >
												</div>
											</div>
										</div>
										<div class="clearfix"></div>
										<?php if(trim($taskinfo['realname']) != null): ?><div class="col-md-3">
											<div class="form-group">
												<p>应用信息</p>
											</div>
										</div>
										<div class="col-md-9 form-group-input">								
											<div class="form-group">
												<div class="input-group select-inline">
													<span><?php echo ($taskinfo['realname']); ?></span>
												</div>
											</div>
										</div>
										<div class="clearfix"></div><?php endif; ?>
										<?php if(trim($taskinfo['package']) != null): ?><div class="col-md-3">
											<div class="form-group">
												<p>应用包名</p>
											</div>
										</div>
										<div class="col-md-9 form-group-input">								
											<div class="form-group">
												<div class="input-group select-inline">
													<span><?php echo ($taskinfo['package']); ?></span>
												</div>
											</div>
										</div>
										<div class="clearfix"></div><?php endif; ?>
										...
										<div class="col-md-9 form-group-input">								
											<div class="form-group">
												<div class="input-group select-inline">
													<span><?php echo ($taskinfo['uploadtime']); ?></span>
												</div>
											</div>
										</div>
										<div class="clearfix"></div>
										...
										<div class="col-md-9 form-group-input">
											<div class="form-group">
												<label class="c-input c-input-radio" for="normaltask">
													<input class="c-radio" type="radio" name="task" id="normaltask" checked="" value="pdf"/>
											...
											<div class="form-group">
												<label class="c-input c-input-radio" for="webtask">
													<input class="c-radio" type="radio" name="task" id="webtask" value="word" />
													<span class="c-icon-radio"></span>
													WORD
												</label>
											</div>
										...
										<div class="col-md-9 form-group-input">
											<div class="form-group">
												<label class="c-input c-input-radio" for="normaltask1">
													<input class="c-radio" type="radio" name="reporttype" id="normaltask1" <?php if(C("IS_PROPOSAL")== 0): ?>checked<?php endif; ?>  value="manage"/>
													<span class="c-icon-radio"></span>
													管理报告
												</label>
											</div>
											<div class="form-group">
												<label class="c-input c-input-radio" for="webtask1">
													<input class="c-radio" type="radio" name="reporttype" id="webtask1" value="techreport" />
													<span class="c-icon-radio"></span>
													技术报告
												</label>
											</div>
										...
										<div class="col-md-9 form-group-input">
											...
											<div class="form-group">
												<label class="c-input c-input-checkbox" for="difengxian">
													<input class="c-checkbox" type="checkbox" name="riskgrade3" id="difengxian" checked value="2" />
													<span class="c-icon-checked"></span>
													低风险
												</label>
											</div>
